...
<main class="policy">
    ...
    <div class="container policy-gallery">
        <figure class="policy-card">
            <img src="<?php echo esc_url( '/wp-content/uploads/2025/10/politicas-01.jpg' ); ?>" alt="Semijoia Ballona na embalagem" loading="lazy">
            <figcaption>Acabamento premium com garantia</figcaption>
        </figure>
        <figure class="policy-card">
            <img src="<?php echo esc_url( '/wp-content/uploads/2025/10/politicas-02.jpg' ); ?>" alt="Detalhe das semijoias com brilho dourado" loading="lazy">
    ...
    <aside class="policy-cta" role="complementary" aria-label="Chamada para ação">
        <div class="container policy-cta-inner">
            ...
            <div class="policy-cta-actions">
                <a class="btn btn-primary" href="<?php echo esc_url( home_url( '/novidades' ) ); ?>">Ver Novidades</a>
                <a class="btn btn-outline" href="<?php echo esc_url( 'https://instagram.com/lojademvp' ); ?>" target="_blank" rel="noopener noreferrer">Siga no Instagram</a>
            </div>
        </div>
    </aside>
</main>
